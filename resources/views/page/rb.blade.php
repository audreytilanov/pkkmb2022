        ...
        <div class="detpodcast">
            ...
            @endif
                <p>
                    ...
                    &emsp;&emsp;&emsp;Jadi, yuk buat video mengenai pentingnya pendidikan karakter yang nantinya dapat mengedukasi para pemuda bangsa kita. Untuk informasi selengkapnya, dapat diklik di bawah ini.
                  </b>
                </p>
        </div>
        <div class="but-dow">
            <a class="hover" href="asset/eksplorasi/generasiberkarakter.pdf" download="GenerasiBerkarakter">SELENGKAPNYA</a>
        </div>
    </div>
    </section>
</section>
