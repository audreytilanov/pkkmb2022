...
<section id="cover">
    ...
    <div class="container">
        <h1 class="title mb-0 aos-init aos-animate" data-aos="fade-right"><span class="font-weight-normal"></span><span>Mission Kompas Ksatria</span><br><span style="font-size: 20px!important">Pengabdian Masyarakat</span></h1>
        <div class="detpodcast">
            ...
            @endif
                <p>
                    &emsp;&emsp;&emsp;Setelah memahami dan mengerjakan “Mission Pengabdian Masyarakat” pada Kompas Ksatria, pastinya kalian sudah mulai memahami nih bahwa salah satu peran mahasiswa ialah melakukan pengabdian masyarakat. Untuk itu, diharapkan setelah kalian mengerjakan <i>mission</i> ini, kalian dapat meningkatkan kepedulian dan empati kalian terhadap lingkungan sosial ya! 
                    <br>
                    &emsp;&emsp;&emsp;Hmz… tidak sabar nih melihat rancangan kalian yang suatu saat nanti dapat kalian langsung implementasikan pada masyarakat!
                    <br>
                    &emsp;&emsp;&emsp;Namun, sebelum itu, yuk <b>saatnya kumpul mission kalian kali ini dengan cara klik tombol di bawah ini.</b>
                </b>
                </p>
        </div>
        <div class="but-dow">
            <a class="hover" href="https://forms.gle/RoLnp3WXHMSi2hYB7">PENGUMPULAN DISINI</a>
        </div>
    </div>
    </section>
</section>
