...
<div style="background-image: url({{url('asset/umum/bg-putih.jpg')}});">
<div class="container">
    <div class="row hov" style="">
        <h1 style="text-align: center;margin-top:50px!important;" class="col-md-12">{{ $ukm->nama }}</h1>
        @if ($ukm->id == 24)
    ...
    <p class="col-md-12" style="text-align: justify;margin-top:50px;">&emsp;&emsp;&emsp;&emsp;{!! $ukm->deskripsi !!}</p>
